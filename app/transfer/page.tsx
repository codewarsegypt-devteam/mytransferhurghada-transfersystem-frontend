...
function Step2DateTime({
  ...
  const handleDateTimeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setFormData((prev) => ({ ...prev, pickupDateTime: e.target.value }));
  };

  // Get minimum date/time (current time + 2 hours for booking lead time)
      ...
      <div className="max-w-md">
        ...
        <div className="relative">
          <input
            ...
            min={getMinDateTime()}
            className="w-full px-4 py-3 text-sm border-2 border-(--light-grey) rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-(--primary-orange) focus:border-(--primary-orange) transition-all"
          />
