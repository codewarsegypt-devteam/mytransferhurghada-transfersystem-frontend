        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <motion.aside variants={fadeLeft} className="lg:col-span-5">
            <div className="bg-white rounded-brand-lg shadow-soft-lg p-5 sm:p-6 md:p-8 lg:sticky lg:top-6">
              ...
              <motion.div
                variants={fadeUp}
                className="mt-6 rounded-xl bg-[#F5F6F6] p-4 flex items-start gap-3"
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Usually within 24 hours. For urgent requests, WhatsApp is
                    fastest.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="bg-white rounded-brand-lg shadow-soft-lg p-5 sm:p-6 md:p-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 mt-2">
                    Tell us what you’re looking for (date, number of people, and
                    preferred trip).
                  </p>
                </div>
              ...
              >
                ...
                <motion.div variants={fadeUp}>
                  <div className="flex items-center justify-between gap-3 mb-2">
                    ...
                    <span
                      className={`text-xs ${
                        messageCount < 10 ? "text-gray-400" : "text-gray-500"
                      }`}
                    >
                      {messageCount} chars
                    </span>
                ...
                <motion.p variants={fadeUp} className="text-xs text-gray-500">
